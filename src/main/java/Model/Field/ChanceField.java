...
public class ChanceField extends Field {
    ...
    public void initChanceCards(){
        chanceCards = new ChanceCard[]{
            new MoveToCard("Chance1# Ryk frem til start og modtag M2", 24),
            ...
            new MoneyCard("Chance5# Du har spist for meget slik betal M2 til banken", -2),
            ...
            new MoneyCard("Chance10# Det er din fødselsdag. Alle giver dig M1. Tillykke med fødselsdagen", 1),
            ...
            new MoneyCard("Chance12# Du har lavet alle dine lektier. Modtag M3 fra banken", 3),
