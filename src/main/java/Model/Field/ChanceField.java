...
public class ChanceField extends Field {
    ...
    public ChanceField(){
        chanceCards = new ChanceCard[]{
            ...
            new ChanceCard("Chance2#Ryk ryk op til 5 felter frem", "#2"),
            new ChanceCard("Chance3#Ryk frem til et orange felt. Hvis det er ledigt får du det gratis ellers skal du betale leje til ejeren", "#3"),
            ...
            new ChanceCard("Chance6#Gratis felt. Ryk frem til et orange eller grønt felt. Hvis det er ledig får du det gratis, ellers skal du betale leje til ejeren", "#6"),
            new ChanceCard("Chance7#Gratis felt. Ryk frem til et lyse blåt felt. Hvis det er ledig får du det gratis, ellers skal du betale leje til ejeren", "#7"),
            ...
            new ChanceCard("Chance11#Gratis felt. Ryk frem til et pink eller mørkeblåt felt. Hvis det er ledigt får du det gratis, ellers skal du betale leje til ejeren", "#11"),
            new ChanceCard("Chance12#Du har lavet alle dine lektier. Modtag M3 fra banken", "#12"),
            new ChanceCard("Chance13#Gratis felt. Ryk frem til et rødt felt. Hvis det er ledig får du det gratis, ellers skal du betale leje til ejeren", "#13"),
