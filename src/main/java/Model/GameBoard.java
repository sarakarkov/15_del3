...
public class GameBoard {
    ...
    public GameBoard(){
        ...
        GUI_Street candyshop = new GUI_Street("Slikbutikken", "$1", "Slik her", "1", Color.blue, Color.black);
        GUI_Street iceshop = new GUI_Street("Iskiosken", "$1", "Is her", "1", Color.blue, Color.black);
        ...
        GUI_Street skatepark = new GUI_Street("Skateparken", "$2", "Hurtig hurtig", "2", Color.yellow, Color.black);
        GUI_Street swimmingpool = new GUI_Street("Swimmingpoolen", "$2", "Svøm lille fisk", "2", Color.yellow, Color.black);
        ...
        GUI_Street bowling = new GUI_Street("Bowlinghallen", "$4", "Bowlinghallen", "4", Color.green, Color.black);
        GUI_Street zoo = new GUI_Street("ZOO", "$4", "ZOO", "4", Color.green, Color.black);
